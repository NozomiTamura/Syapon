...
public class GameControl_ohiru : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //上に移動
        gamestart.transform.position = new Vector3(16.2f, 1.1f, 0f);
    ...
    void Update()
    {
        ...
        if(flag_scr.GetFlag()>0){
            ...
            {   
                ...
                gamestart.transform.position = new Vector3(15.3f, -2.2f, 0f);
            }
            else {
                //周波数　＝　音の高さで判別
                Material mat = Resources.Load("wakka") as Material;
                ...
                if (freq2 >= Hz)
                {
                    ...
                    gamestart.GetComponent<Renderer>().material = mat;
                    //上に移動
                    gamestart.transform.position = new Vector3(15.3f, 1.1f, 0f);
                ...
                /*else if (freq2 < 1000 && freq2 >= 500)
                {
                    ...
                    gamestart.GetComponent<Renderer>().material = mat;
                    //元に戻る
                    gamestart.transform.position = new Vector3(16.2f, -2.2f, 0f);
                    //カウントダウン戻す
                    countdown = 1.0f;
                }*/
                else if (freq2 < Hz && freq2 > 10)
                {
                    ...
                    gamestart.GetComponent<Renderer>().material = mat;
                    //下に移動
                    gamestart.transform.position = new Vector3(15.3f, -5.5f, 0f);
